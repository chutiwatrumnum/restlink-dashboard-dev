      ...
      <Form
        ...
        onFinish={async (value) => {
          ConfirmModal({
            ...
            onOk: async () => {
              const payload: AddNewProjectNewType = {
                id,
                title: value.title,
              ...
              const result = await dispatch.projectNew.editAnnounce(payload);
              if (result) {
                announceForm.resetFields();
                onOk();
                onRefresh();
        ...
        <div className="announceModalColumn">
          <div className="announceModalContainer">
            <div className="announceModalColumn">
              <Form.Item<ProjectNewFormDataType>
                label="Title"
                name="title"
                rules={requiredRule}>
                <Input
              ...
              <Form.Item<ProjectNewFormDataType> label="Image" name="image">
                <UploadImageGroup
                  onChange={(url) => {
                    setPreviewImage(url);
                  }}
            ...
            <div className="announceModalColumn">
              ...
              <Form.Item<ProjectNewFormDataType> label="URL" name="link">
